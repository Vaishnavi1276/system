...
using ECommerce.Services.Customers.TestShared.Fakes.RestockSubscriptions.ValueObjects;
using FluentAssertions;
using Tests.Shared.XunitCategories;

namespace ECommerce.Services.Customers.TestShared.Fakes.RestockSubscriptions;
