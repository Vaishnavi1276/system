...
using ECommerce.Services.Customers.TestShared.Fakes.Customers.Requests;
using ECommerce.Services.Customers.TestShared.Fixtures;
using FluentAssertions;
using Microsoft.AspNetCore.Mvc;
using Tests.Shared.Extensions;

namespace ECommerce.Services.Customers.EndToEndTests.Customers.Features.CreatingCustomer.v1;
