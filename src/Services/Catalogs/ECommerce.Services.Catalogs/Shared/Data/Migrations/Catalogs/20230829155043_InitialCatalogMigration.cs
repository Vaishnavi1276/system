        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    ...
                    {
                        productid = table
                            .Column<long>(name: "product_id", type: "bigint", nullable: false)
                            .Annotation(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table =>
                    new
                    {
                        ...
                        productstatus = table.Column<string>(
                            name: "product_status",
                            type: "character varying(25)",
                            maxLength: 25,
                            nullable: false,
                        ...
                        stockrestockthreshold = table.Column<int>(
                            name: "stock_restock_threshold",
                            type: "integer",
                            nullable: false
                        ),
                        stockmaxstockthreshold = table.Column<int>(
                            name: "stock_max_stock_threshold",
                            type: "integer",
                            nullable: false
                        ),
                        dimensionsheight = table.Column<int>(
